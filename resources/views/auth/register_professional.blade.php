            ...
            <div class="center-sign">
                ...
                <div class="panel panel-sign">
                    <div class="panel-title-sign mt-xl text-right">
                        <h2 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Registro PROFESIONALES</h2>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('register',1) }}">
                            ...
                            @endif
                            <input type="hidden" name="user_type" id="tipo_usuario" value=1> <!-- tipo_usuario = 1 => Profesional -->
