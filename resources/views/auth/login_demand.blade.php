        ...
        <div class="featured-boxes separador-min">
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="featured-box featured-box-primary align-left mt-xlg">
                        <div class="box-content">
                                ...
                                <form action="{{ route('login', 1) }}" id="frmSignInDemanda" method="post">
                                    {{ csrf_field() }}
                                    @if (session('status'))
                                    ...
                                    <div class="row">
                                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                            <div class="col-md-12">
                                                <a class="pull-right" href="{{ url('password/reset') }}">(¿Olvido su contraseña?)</a>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <a href="#" class="btn btn-danger btn-transparent "><i class="fa fa-share-square-o"></i>&nbsp;Ir al Registro</a>
                </div>
            </div><hr>
