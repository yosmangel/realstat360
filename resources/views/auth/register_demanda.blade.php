                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <div class="form-group mb-lg {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input id="name" name="name" type="text" class="form-control input-lg" value="{{ $usuario_demanda->name }}" required autofocus>
                                @if ($errors->has('name')) 
                            ...
                            <div class="form-group mb-lg {{ $errors->has('lastname') ? ' has-error' : '' }}">
                                ...
                                <input id="lastname" name="lastname" type="text" class="form-control input-lg" value="{{ $usuario_demanda->lastname }}" required>
                            ...
                            <div class="form-group mb-lg {{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input id="email" name="email" type="email" class="form-control input-lg" value="{{ $usuario_demanda->email }}" required>
                                 @if ($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <p class="text-center">¿Ya tiene una cuenta? <a href="{{ url('/ingresar/demanda') }}">¡Ingresar!</a></p>
