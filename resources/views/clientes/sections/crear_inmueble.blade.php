<div class="col-xs-12">
	...
	<div class="row">
		...
		<form class="form-horizontal" novalidate="novalidate" action="{{ route('inmuebles.store') }}" method="post">
			...
			<input name="cliente_id" id="btn-id" type="hidden" value="{{ $id_cliente }}">
			<div class="tab-content">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-7">
										<select data-plugin-selectTwo class="form-control populate" name="agua_caliente" id="w1-agua-caliente" style="width: 100%">
											<option value="">::Selecionar::</option>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-7">
										<select data-plugin-selectTwo class="form-control populate" name="calefaccion" id="w1-calefaccion" style="width: 100%">
											<option value="">::Selecionar::</option>
											<option value="Gas Natural">Gas Natural</option>
											<option value="Electricidad">Electricidad</option>
											<option value="Gasoleo">Gasóleo</option>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-7">
										<select data-plugin-selectTwo class="form-control populate" name="certificado_energetico" id="w1-calefaccion" style="width: 100%">
											<option value="">::Selecionar::</option>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-7">
										<select data-plugin-selectTwo class="form-control populate" name="conservacion" id="w1-conservacion" style="width: 100%">
											<option value="">::Selecionar::</option>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-7">
										<select data-plugin-selectTwo class="form-control populate" name="orientacion" id="w1-orientacion" style="width: 100%">
											<option value="">::Selecionar::</option>
					...
					<div class="col-xs-12">
						<div class="row">
							...
							<div class="col-md-8">
							<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success btn-submit-inmueble"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Guardar</button>
							</div> 
						</div>
						<br><br> 
					</div>
