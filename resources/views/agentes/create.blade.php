					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="{{ route('agentes.create') }}">Nuevo Agente</span></a></li>
							</ol>
						...
						<div class="col-md-12">
							<section class="panel form-wizard" id="w1">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Crear Agente</h2>
								</header>
								<div class="panel-body panel-body-nopadding">
									...
									@else
										<form class="form-horizontal" novalidate="novalidate" action="{{ route('agentes.store') }}" method="post">
											{{ csrf_field() }}
											...
											<section class="panel panel-featured panel-featured-primary">
												...
												<div class="panel-body">
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-4 col-md-3">
															<div class="radio-custom radio-primary">
																<input type="radio" id="radioSr" name="tratamiento" value=1 checked="checked">
																<label for="radioSr">Señor (Sr.)</label>
															</div>
														</div>
														<div class="col-xs-12 col-sm-4 col-md-3">
															<div class="radio-custom radio-warning">
																<input type="radio" id="radioSra" name="tratamiento" value=0>
													...
													<div class="form-group">
														...
														<div class="col-md-7">
															<input type="text" class="form-control input-sm" name="apellidos" id="w1-apellidos" required>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-2">
															<div class="radio-custom radio-success">
																<input type="radio" id="acceso-permitido" name="acceso" id="acceso-permitido" value=1 checked="checked">
																<label for="acceso-permitido">Permitido</label>
															</div>
														</div>
														<div class="col-xs-12 col-sm-2">
															<div class="radio-custom radio-default">
																<input type="radio" id="acceso-no-permitido" name="acceso" value=0>
																		...
																		<tr>
																			...
																			<td>
																				<label class="checkbox">
																					...
																					<input type="checkbox" id="lun-man" value=1 name="lun_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="mar_man">
																					<input type="checkbox" id="lun-man" value=1 name="mar_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="mie_man">
																					<input type="checkbox" id="mie-man" value=1 name="mie_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="jue_man">
																					<input type="checkbox" id="jue-man" value=1 name="jue_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="vie_man">
																					<input type="checkbox" id="vie-man" value=1 name="vie_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="sab_man">
																					<input type="checkbox" id="sab-man" value=1 name="sab_man">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="dom_man">
																					<input type="checkbox" id="dom-man" value=1 name="dom_man">
																				</label>
																			</td>
																		</tr>
																		<tr>
																			...
																			<td>
																				<label class="checkbox">
																					...
																					<input type="checkbox" id="lun-tar" value=1 name="lun_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="mar_tar">
																					<input type="checkbox" id="lun-tar" value=1 name="mar_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="mie_tar">
																					<input type="checkbox" id="mie-tar" value=1 name="mie_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="jue_tar">
																					<input type="checkbox" id="jue-tar" value=1 name="jue_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="vie_tar">
																					<input type="checkbox" id="vie-tar" value=1 name="vie_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="sab_tar">
																					<input type="checkbox" id="sab-tar" value=1 name="sab_tar">
																				</label>
																			</td>
																			<td>
																				<label class="checkbox">
																					<input type="hidden" value=0 name="dom_tar">
																					<input type="checkbox" id="dom-tar" value=1 name="dom_tar">
																				</label>
																			</td>
																		</tr>
																	</tbody>
												...
												<div class="panel-body">
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-3 col-md-2">
															<div class="radio-custom radio-primary">
																<input type="radio" id="clientes-todos" name="clientes_permitidos" checked="checked" value=1>
																<label for="clientes-todos">Todos</label>
															</div>
														</div>
														<div class="col-xs-12 col-sm-5 col-md-5">
															<div class="radio-custom radio-warning">
																<input type="radio" id="clientes-asignados" name="clientes_permitidos" value=0>
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-3 col-md-2">
															<div class="radio-custom radio-primary">
																<input type="radio" id="acciones-todas" name="acciones_permitidas" checked="checked" value=1>
																<label for="acciones-todas">Todas</label>
															</div>
														</div>
														<div class="col-xs-12 col-sm-5 col-md-5">
															<div class="radio-custom radio-warning">
																<input type="radio" id="acciones-asignadas" name="acciones_permitidas" value=0>
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-3 col-md-2">
															<div class="radio-custom radio-primary">
																<input type="radio" id="inmuebles-todos" name="inmuebles_permitidos" checked="checked" value=1>
																<label for="inmuebles-todos">Todos</label>
															</div>
														</div>
														<div class="col-xs-12 col-sm-5 col-md-5">
															<div class="radio-custom radio-warning">
																<input type="radio" id="inmuebles-asignados" name="inmuebles_permitidos" value=0>
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<div class="collapse" id="telefono2">
															...
															<div class="col-md-3">
																<input type="text" class="form-control input-sm" name="telefono2" id="w1-telefono2" required>
															</div>
															<div class="col-md-2">
													...
													<div class="form-group">
														<div class="collapse" id="movil2">
															...
															<div class="col-md-3">
																<input type="text" class="form-control input-sm" name="movil2" id="w1-movil2" required>
															</div>
															<div class="col-md-2">
													...
													<div class="form-group">
														<div class="collapse" id="fax2">
															...
															<div class="col-md-3">
																<input type="text" class="form-control input-sm" name="fax2" id="w1-fax2" required>
															</div>
															<div class="col-md-2">
											...
											<section class="panel ">
												<div class="col-xs-12 col-md-7 col-md-offset-4">
													<div class="form-group">
														<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Guardar Agente</button>
													</div>
												</div>
											</section>
											<br><br><br>
