@extends('layouts.app')
@section('title','Registro Demanda')
@section('content')
    <div class="container">
                    ...
                    <div class="featured-box featured-box-primary align-left mt-xlg">
                        <div class="box-content">
                            @if($tipo_registro == 'propietario')
                                <h4 class="heading-primary text-uppercase mb-md">Registro de {{ $type }}</h4>
                                <form action="{{ route('register') }}" id="frmSignUpPropietario" method="post">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="user_type" id="tipo_usuario" value={{ $user_type }}> <!-- tipo_usuario = 1 => Profesional , tipo_usuario = 1 => Propietario -->
                                    <div class="row">
