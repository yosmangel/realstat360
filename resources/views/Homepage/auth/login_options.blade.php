                    ...
                    <div class="row mt-xl">
                        <div class="col-md-6">
                            <div class="testimonial testimonial-style-4 appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="0">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <a href="{{ url('/ingresar/profesionales') }}" class="btn btn-primary btn-card btn-block btn-lg"><strong>AGENCIAS Y <br>PROFESIONALES</strong></a>
                                    </div>
                                    <div class="col-xs-6">
                                        <a href="{{ url('/ingresar/propietarios') }}" class="btn btn-warning btn-card btn-block btn-lg"><strong>PROPIETARIOS <br>PARTICULARES</strong></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="testimonial testimonial-style-4 appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="0">
                                ...
                                <a href="{{ url('/ingresar/demanda') }}" class="btn btn-info btn-card  btn-block btn-lg"><strong>DEMANDA Y BÚSQUEDA <br> DE INMUEBLES</strong></a>
                            </div>
