...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Confirmación de Mensaje de Solicitud a RealState370</title>
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" width="100%">
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">
                                <h2>¡Hola! {{ $username }}</h2>
                                <p style="">Su solicitud ha sido enviada a RealState360. Le estaremos respondiendo en el menor tiempo posible.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">
                        ...
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">
                                <hr>
                                Visitenos en <a href="https://www.realstate360.com">RealState360.com</a>   
                            </td>
                        </tr>
