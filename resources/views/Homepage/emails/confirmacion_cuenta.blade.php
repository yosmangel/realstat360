...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Confirmación de Cuenta en RealState360</title>
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" width="100%">
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">
                                ...
                                <p style="">Has sido registrado correctamente en RealStte360.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px;">
                                Por favor, acceda al siguiente enlace para activar su cuenta 
                                <a href="{{ $activacion }}">{{ $activacion }}</a>
                            </td>
                        </tr>
                    </table>
                </td>
