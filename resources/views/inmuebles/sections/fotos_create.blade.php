	...
	<div class="panel-body">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="{{ route('imagenes.store') }}" class="dropzone" id="dropzone" method="post" files="true">
									...
									<input type="hidden" name="inmueble_id" id="imainmueble_id" value="">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="{{ route('archivos.store') }}" class="dropzone" id="dropzone2" method="post" files="true">
									<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<input type="hidden" name="inmueble_id" id="docinmueble_id" value="">
		...
		<div class="col-xs-12">
			<div class="row">
				...
				<div class="col-md-8">
				<button type="button" class="mb-xs mt-xs mr-xs btn btn-success btn-continuar" data-getouttab="tab-fotos" data-getoutcontent="w1-fotos" data-getintab="tab-internos" data-getincontent="w1-internos"><i class="fa fa-floppy-o" aria-hidden="true"></i> Continuar <i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
				</div> 
			</div>
			<br><br>
		</div>
