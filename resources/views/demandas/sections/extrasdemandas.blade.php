...
<div class="panel-group" id="accordion">
	<input id="iddemanda" type="hidden" value=""></input>
	<!-- ACORDION CALIDADES-->
	<div id="acordion-calidades" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-calidades" class="accordion-body collapse in">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-calidades" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
	...
	<div id="acordion-superficies" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-superficies" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-superfices" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
					<input name="form_seccion" type="hidden" value="form_superficies">
					<div class="row">
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Artura real</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-altura-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-altura-desde" type="number" min=0 name="altura_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-altura-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-altura-hasta" type="number" min=0 name="altura_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Número de Suites</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-suites-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-suites-desde" type="number" min=0 name="suites_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-suites-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-suites-hasta" type="number" min=0 name="suites_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							...
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-superficie-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-superficie-desde" type="number" min=0 name="suputil_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-superficie-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-superficie-hasta" type="number" min=0 name="suputil_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Superficie cocina</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-cocina-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-cocina-desde" type="number" min=0 name="supcoci_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-cocina-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-cocina-hasta" type="number" min=0 name="supcoci_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Superficie edificada</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-edificada-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-edificada-desde" type="number" min=0 name="supedif_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-edificada-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-edificada-hasta" type="number" min=0 name="supedif_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Superficie salón</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-salon-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-salon-desde" type="number" min=0 name="supsalon_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-salon-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-salon-hasta" type="number" min=0 name="supsalon_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
					</div><br>
					<div class="row">
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center">Superficie terrazas</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-terrazas-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-terrazas-desde" type="number" min=0 name="supterr_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-sup-terrazas-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-sup-terrazas-hasta" type="number" min=0 name="supterr_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center"># Habitaciones Dobles</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-habdobles-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-habdobles-desde" type="number" min=0 name="hab2_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-habdobles-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-habdobles-hasta" type="number" min=0 name="hab2_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-6 col-lg-4 border-section-form">
							<p class="text-center"># Habitaciones Individuales</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-habindividuaes-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-habindividuaes-desde" type="number" min=0 name="hab1_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-habindividuaes-hasta">Hastas</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-habindividuaes-hasta" type="number" min=0 name="hab1_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
					</div><br>
	...
	<div id="acordion-carpinteria" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-carpinteria" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-carpinteria" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-6">
							<div class="form-group">
								<label class="col-xs-12 col-md-4 control-label" for="w1-persianas">Persianas</label>
								<div class="col-xs-12 col-md-8">
									<input id="w1-persianas" type="text" name="persianas" class="form-control">
								</div>
							</div>
						</div>
					</div><br>
					<div class="row">
						<div class="col-xs-10 col-md-5 col-md-offset-6 border-section-form">
							<p class="text-center"># Armarios</p>
							<div class="form-group">
								<label class="col-xs-12 col-md-2 control-label" for="w1-armarios-desde">Desde</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-armarios-desde" min=0 type="number" name="armarios_desde" class="form-control" placeholder="0">
								</div>
								<label class="col-xs-12 col-md-2 control-label" for="w1-armarios-hasta">Hasta</label>
								<div class="col-xs-12 col-md-4">
									<input id="w1-armarios-hasta" min=0 type="number" name="armarios_hasta" class="form-control" placeholder="0">
								</div>
							</div>
						</div>
					</div><br>
		...
		<div id="contenido-acabados" class="accordion-body collapse">
			<div class="panel-body">
				<div class="panel-body">
					...
					<form class="form-horizontal extras" id="form-acabados" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
						<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
						<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
	...
	<div id="acordion-instalaciones" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-instalaciones" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-instalaciones" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
	...
	<div id="acordion-datos-economicos" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-datos-economicos" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-economicos" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
	...
	<div id="acordion-finca" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-finca" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-finca" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
	...
	<div id="acordion-situacion" class="panel panel-accordion panel-accordion-primary">
		...
		<div id="contenido-situacion" class="accordion-body collapse">
			<div class="panel-body">
				...
				<form class="form-horizontal extras" id="form-situacion" action="{{ route('extrasdemandas.update', 0) }}" novalidate="novalidate">
					<input name="_token" type="hidden" value = "{{ csrf_token() }}" id="token">
					<input class="extras-dem-id" name="demanda_id" type="hidden" value="">
...
<div class="col-xs-12">
	<div class="row">
		...
		<div class="col-md-8">
		<button type="button" class="mb-xs mt-xs mr-xs btn btn-success btn-cont-coincidentes" data-getouttab="tab-extras" data-getoutcontent="w1-extras" data-getintab="tab-fotos" data-getincontent="w1-fotos"><i class="fa fa-floppy-o" aria-hidden="true"></i> Continuar <i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
		</div> 
	</div>
	<br><br>
</div>