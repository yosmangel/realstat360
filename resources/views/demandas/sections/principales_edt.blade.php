	...
	<div class="col-md-12"> 
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-7">
						<select data-plugin-selectTwo class="form-control populate" id="w1-cliente-id" name="cliente_id" required>
							<option value="{{ $demanda->cliente->id }}">{{ $demanda->cliente->nombre }}</option>
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-4">
						<div class="radio-custom radio-info">
							<input type="radio" id="interesado-inmueble" name="tipo_demanda" <?php echo ($demanda->tipo_demanda == 'inmueble') ? 'checked' : ''; ?> value='inmueble'>
							<label for="persona">Interesado en un inmueble</label>
						</div>
					</div>
					<div class="col-xs-12 col-sm-4">
						<div class="radio-custom radio-success">
							<input type="radio" name="tipo_demanda"  <?php echo ($demanda->tipo_demanda == 'describir_demanda') ? 'checked' : ''; ?> value='describir_demanda'>
				...
				<div id="seccion-interesado-inmueble" class="collapse <?php echo ($demanda->tipo_demanda == 'inmueble') ? 'in' : ''; ?>">
				...
				<div id="seccion-describir-demanda" class="collapse <?php echo ($demanda->tipo_demanda == 'describir_demanda') ? 'in' : ''; ?>">
					@include('demandas.sections.describir_demanda_edt') 
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-7 col-md-offset-4">
