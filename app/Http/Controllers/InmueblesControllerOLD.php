...
class InmueblesController extends Controller
{
    ...
    public function index($id = null)
    {
        if ($id == null) {
            ...
            $inmuebles =  Inmueble::select('id','tipo_id','estado','superficie',
                                           'municipio_id','calle', 'numero','id_portada','pais_id',
            ...
            //Mapper::map(53.381128999999990000, -1.470085000000040000, ['zoom' => 15, 'center' => true, 'marker' => false, 'type' => 'HYBRID', 'overlay' => 'TRAFFIC']);
    ...
    { 
        ...
        return view('Homepage.propietaries.create',compact('inmueble','types','provinces','cities','title'));
    }
