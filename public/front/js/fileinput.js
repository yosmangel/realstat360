...
(function (factory) {
    ...
    previewCache = {
        ...
        init: function (obj) {
            ...
            previewCache.data[id] = {
                ...
                actions: function (showDelete, disabled, url, key) {
                    return obj._renderFileActions(showDelete, disabled, url, key, true);
                }
            };
        },
        fetch: function (id) {
        ...
        footer: function (id, i, isDisabled, size) {
            ...
            var config = data.config[i], caption = ifSet('caption', config), width = ifSet('width', config, 'auto'),
                ...
                actions = data.isDelete ? data.actions(false, showDel, showZoom, disabled, url, key) : '',
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-primary btn-background',
        removeIcon: '<i class="fa fa-trash-o" aria-hidden="true"></i>',
